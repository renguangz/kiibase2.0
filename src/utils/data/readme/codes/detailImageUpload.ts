...
export const detailImageUpload: CodeTextType[] = [
  { type: 'text', text: '{' },
  ...
  { type: 'text', text: ': ' },
  { type: 'text', text: '"ImageUpload"', color: 'orange' },
  { type: 'text', text: ',' },
  /* end */
  ...
  /* start */
  { type: 'wrap', text: '' },
  { type: 'text', tabs: 1, text: '"rows"', color: 'blue' },
  { type: 'text', text: ': ' },
  ...
  /* start */
  { type: 'wrap', text: '' },
  { type: 'text', tabs: 1, text: '"url"', color: 'blue' },
  { type: 'text', text: ': ' },
  { type: 'text', text: '"若無則回傳 null"', color: 'orange' },
  { type: 'text', text: ',' },
  /* end */
